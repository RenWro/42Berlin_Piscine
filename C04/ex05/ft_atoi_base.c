...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/19 20:10:23 by rwrobles          #+#    #+#             */
/*   Updated: 2024/10/19 20:42:07 by rwrobles         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Returns the index of a character in the base, 
or -1 if the character is not in the base. */
...
/* Converts a string representing a number in any 
base (defined by 'base') to an integer.
Checks if the base is valid, skips whitespaces and 
signs, and performs the conversion. */
...
/* Tests the ft_atoi_base function or decimal, binary 
and hexadecimal inputs and bases. */
int	main(void)
{
